...
if __name__ == "__main__":
    ...
    argparser.add_argument('source', default=100,help='Source airport code')
    argparser.add_argument('destination',default=100, help='Destination airport code')
    argparser.add_argument('date', default=100,help='MM/DD/YYYY')
